	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==addbutton) {
			...
			if(kode.startsWith("PD-")) {
				try {
					if(rset.next()) {
						JOptionPane.showMessageDialog(center, "Kode sudah dipakai menu lain", "Error", JOptionPane.ERROR_MESSAGE);
					}else {
						data.insert(kode, nama, harga, stok);
						JOptionPane.showMessageDialog(center, "Insert menu sukses dilakukan", "Success", JOptionPane.PLAIN_MESSAGE);
					}
